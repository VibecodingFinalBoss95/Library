...
local DualSlider = LoadModule("Components/DualSlider.lua")(Theme, Utility)
...
local TextLabel = LoadModule("Components/TextLabel.lua")(Theme, Utility)
local Paragraph = LoadModule("Components/Paragraph.lua")(Theme, Utility)

local Section = LoadModule("Section.lua")(Theme, Utility, Toggle, Button, Dropdown, Slider, DualSlider, AdaptiveInput, ColorPicker, TextLabel, Paragraph)
